package kopyae.lovememory.com.adapter;
...
import kopyae.lovememory.com.helper.Pageable;


/**
 * Project : YoYo
 * Created by Rahul Kumar on 19.10.2016 .
 * Description : Ready to use pre-configured Recycler View Adapter.
 * To use, please create child of this class to get pre-configured features.
 **/
public abstract class BaseRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public BaseRecyclerViewAdapter(List<Pageable> items) {
